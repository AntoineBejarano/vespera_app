...
export const PHOTO_TAG_OPTIONS = [
  { id: "face", label: "Cara / face" },
  { id: "selfie", label: "Selfie" },
  { id: "body", label: "Cuerpo / body" },
  { id: "fullbody", label: "Cuerpo entero" },
  { id: "ass", label: "Culo / ass" },
  { id: "tits", label: "Pecho / tits" },
  { id: "legs", label: "Piernas / legs" },
  { id: "lingerie", label: "Lencería" },
  { id: "nude", label: "Nude" },
  { id: "mirror", label: "Espejo / mirror" },
  { id: "bed", label: "Cama / bed" },
