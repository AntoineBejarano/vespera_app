  ...
  switch (slug) {
    case "terms":
      return [
        ...
        "1. Eligibility. You must be old enough to use online services in your jurisdiction and able to form a binding contract. After Dark (adult partner capabilities) is invite-only, strictly 18+, and governed by the Adult Content Notice — it is not self-service signup.",
        "2. Nature of the Service. The general Service provides AI character infrastructure: identity layers, memory, relationships, voice, and channel connectors for creators, educators, and businesses. Interactions are automated AI systems — we disclose this under EU AI Act transparency expectations (Art. 50 baseline). Sexually explicit partner capabilities are available only under audited After Dark workspace approval; consumer adult delivery additionally requires highly effective age assurance and is not enabled by workspace approval alone.",
    ...
    case "adult-content":
      return [
        DISCLAIMER,
        `${brand} After Dark is a partner-access surface of ${companyName}. It is not open self-service signup. Apply via partners@vesperer.com.`,
        "Workspace approval authorizes an organization to configure adult capabilities in Studio. It does not, by itself, authorize delivery of pornographic or explicit content to end users.",
        "End-user adult delivery requires highly effective age assurance (HEAA) appropriate to the jurisdiction (including UK Online Safety expectations). Self-attestation checkboxes and cookies are not HEAA.",
        "Until HEAA is integrated for a given channel, After Dark remains landing + partner configuration only — no public adult companions, no adult Telegram consumer delivery, and no public explicit image generation.",
        "Zero tolerance for sexual content involving minors, age-play involving minors, non-consensual intimate imagery, celebrity/real-person sexual deepfakes without verified written consent, or nudification of real people.",
        "Creators connecting bots must surface AI disclosure and must not knowingly allow minors to interact with adult personas.",
        "Payments. After Dark paid features are not processed through Stripe. When adult billing is enabled under partner terms, it will use an adult-compatible processor and/or platform-native rails.",
        `Questions / partner applications: partners@vesperer.com · Legal: ${contactEmail} · ${companyWebsite}`,
      ];
    case "billing":
      return [
        DISCLAIMER,
